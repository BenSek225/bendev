...
export default function AboutPage() {
  return <main className="bg-primary text-text-primary">
    <section className="section-spacing container-portfolio">
      <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
        <motion.div variants={fadeUp}><SectionLabel index="01">À PROPOS</SectionLabel></motion.div>
        <motion.h1 variants={staggerItem} className="mt-8 max-w-4xl font-serif text-h2 text-balance">Je transforme vos idées complexes en solutions digitales <em className="text-accent">simples et puissantes.</em></motion.h1>
        <motion.p variants={staggerItem} className="mt-8 max-w-2xl text-body-lg text-secondary">Passionné par la création d&apos;expériences numériques exceptionnelles, je combine créativité et expertise technique pour donner vie à vos projets.</motion.p>
      </motion.div>
    </section>

    <section className="container-portfolio grid gap-10 pb-24 md:grid-cols-[minmax(260px,0.8fr)_1.2fr] md:gap-20 md:pb-32">
